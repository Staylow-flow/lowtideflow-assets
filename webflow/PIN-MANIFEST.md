...
|-------|----------|--------|-----------|
| `js/hero/rock-scene.js` | Page footer tag 1 | `54cc99a` | `clean-slate-footer.html` |
| `js/ltf.js` | Page footer tag 2 | `54cc99a` | `clean-slate-footer.html` |
| `js/ui/hero-viewport.js` | Page footer tag 3 | `54cc99a` | `clean-slate-footer.html` |

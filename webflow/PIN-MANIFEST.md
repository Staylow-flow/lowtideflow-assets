...
|-------|----------|--------|-----------|
| `js/hero/rock-scene.js` | Page footer tag 1 | `7c89f3f` | @ `50d1ec8` rock-scene; pin ships logo 20px H1 gutter |
| `js/ltf.js` | Page footer tag 2 | `7c89f3f` | `clean-slate-footer.html` |
| `js/ui/hero-viewport.js` | Page footer tag 3 | `7c89f3f` | MODE B logo 20px left of H1 text |

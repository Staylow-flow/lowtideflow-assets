...
|-------|----------|--------|-----------|
| `js/hero/rock-scene.js` | Page footer tag 1 | `5deba15` | specs SLAM_CARD_H 240 + footer FX docs |
| `js/ltf.js` | Page footer tag 2 | `5deba15` | `clean-slate-footer.html` |
| `js/ui/hero-viewport.js` | Page footer tag 3 | `5deba15` | MODE B logo 20px left of H1 text |

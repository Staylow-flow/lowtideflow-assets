...
|-------|----------|--------|-----------|
| `js/hero/rock-scene.js` | Page footer tag 1 | `7de55ad` | `clean-slate-footer.html` |
| `js/ltf.js` | Page footer tag 2 | `7de55ad` | `clean-slate-footer.html` |
| `js/ui/hero-viewport.js` | Page footer tag 3 | `7de55ad` | `clean-slate-footer.html` |

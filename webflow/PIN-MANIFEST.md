...
|-------|----------|--------|-----------|
| `js/hero/rock-scene.js` | Page footer tag 1 | `b0522da` | pinned with vault pre-pin stack fix |
| `js/ltf.js` | Page footer tag 2 | `b0522da` | `clean-slate-footer.html` — imports fixed `specs-vault-slam.js` |
| `js/ui/hero-viewport.js` | Page footer tag 3 | `b0522da` | MODE B logo 20px left of H1 text |
